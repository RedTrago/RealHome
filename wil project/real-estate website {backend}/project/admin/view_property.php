...
<head>
   ...
   <!-- google maps api  -->
   <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAqU-azkY-jMaJzOpDrQYvWKg-OPgjKbcw&callback=initMap" async defer></script>
...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <p class="location"><i class="fas fa-map-marker-alt"></i><span><a href="https://www.google.com/maps/search/?api=1&query=<?= urlencode($fetch_property['latitude'] . ',' . $fetch_property['longitude']); ?>" target="_blank"><?= $fetch_property['address']; ?></a></span></p>
      <div id="map" style="height: 5px; width: 100%;"></div>
      <div class="info">
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>Deposit Amount : </i><span><span class="fa-solid fa-dollar-sign" style="margin-right: .5rem;"></span><?= $fetch_property['deposit']; ?></span></p>
